var
  words = ['Protonicgod', 'Kushagra', 'a Community Manager', 'a Community Moderator'],
  part,
  i = 0,
  offset = 3,
  len = words.length,
...
canvas.addEventListener('mousemove', e => {
    ...
    updatePointerDragData(pointer, posX, posY);
});
...
function updatePointerDragData (pointer, posX, posY) {
    pointer.color = generateColor();
    pointer.prevTexcoordX = pointer.texcoordX;
    pointer.prevTexcoordY = pointer.texcoordY;
    pointer.texcoordX = posX / canvas.width;
